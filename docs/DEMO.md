...
3. Si Supabase est injoignable : `npm run debug:seed` dans le terminal montre le moteur consolider les deux sociétés sans réseau, et la restitution bascule sur les livrables écrits et le classeur codir exporté.
